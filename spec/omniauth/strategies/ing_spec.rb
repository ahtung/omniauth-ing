...
describe OmniAuth::Strategies::Ing do
  ...
  let(:enterprise) do
    OmniAuth::Strategies::Ing.new('ING_KEY', 'ING_SECRET',
        {
            :client_options => {
  ...
  describe '#callback_url' do
    it 'is a combination of host, script name, and callback path' do
      ...
      expect(subject.callback_url).to eq('https://example.com/sub_uri/auth/ing/callback')
    end
  end
end
